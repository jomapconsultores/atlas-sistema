-- ============================================================
-- Reporte de jornada, horas trabajadas y sueldo proporcional
-- sobre las marcaciones de asistencia.
-- Ejecutar en el SQL Editor de Supabase, una sentencia a la vez.
-- ============================================================

-- 1) Horas extra por día. Se guardan en la propia marcación del día para que
--    el recálculo del mes sea la simple suma de la columna (sin tabla aparte).
...
--    horas_dia               -> jornada diaria que DEBE cumplir (ej. 8 completo, 4 medio tiempo)
--    dias_mes                -> días laborables que debe cumplir en el mes
--    horas_jornada_completa  -> referencia de tiempo completo; horas_dia/esta = proporción de jornada
--    sueldo_tiempo_completo  -> sueldo mensual SI trabajara a tiempo completo (SBU 2026: 482.00)
--    recargo_hora_extra      -> recargo por defecto cuando el día no trae tipo (1.5)
--  El valor hora NO sale de esta tabla: es sueldo mensual / 240 (Art. 47/55).
